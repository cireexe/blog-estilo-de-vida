...
<body>
    ...
    <section id="seccion-articulos">
        ...
        // Consulta para obtener los artículos de comidas
        $sqlObtenerComida = "SELECT id, titulo, contenido, imagen FROM articulos WHERE seccion = 'comida' ORDER BY id DESC LIMIT 5";

        $resultado = $conexion->query($sqlObtenerComida);
        ...
        if ($resultado->num_rows > 0) {
            ...
            echo "No hay artículos de Comida disponibles.";
        }
        $conexion->close();
        ?>
    </section>
